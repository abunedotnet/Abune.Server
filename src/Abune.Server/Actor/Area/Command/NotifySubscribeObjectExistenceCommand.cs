//-----------------------------------------------------------------------
// <copyright file="NotifySubscribeObjectExistenceCommand.cs" company="Thomas Stollenwerk (motmot80)">
...
namespace Abune.Server.Actor.Command
{
    ...
    /// </summary>
    public class NotifySubscribeObjectExistenceCommand : ICanRouteToObject
    {
